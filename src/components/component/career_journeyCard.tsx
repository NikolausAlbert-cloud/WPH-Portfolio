...
const Career_journeyCard: React.FC = () => {
  return (
    <div className='flex flex-col gap-4 md:gap-6 [&>div]:last:[&>div]:first:bg-orange-300 [&>div]:last:[&>div]:first:h-[calc(100%-2rem)] md:[&>div]:last:[&>div]:first:h-[calc(100%-1.5rem)]'>
